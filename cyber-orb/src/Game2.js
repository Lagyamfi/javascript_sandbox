...
Ball.Game.prototype = {
    create: function () {
        ...
        // initialize the ball objectin and assign properties
        ...
        // device orientation to allow tilting on mobile device as input
        ...
        this.timeText = this.game.add.text(15, 15, 'Time: ' +this.timer, this.fontBig);
    ...
    update: function() {
        // check this.keys against player input at every frame
    ...
    finishLevel: function() {
        if (this.level >= this.maxLevels) {
            ...
            alert('Congratulatoins, game completed! \n Total time of play: ' + this.totalTimer + ' seconds!');
